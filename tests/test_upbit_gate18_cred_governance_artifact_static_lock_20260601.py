...
REPORT = ROOT / r"reports/upbit_gate18_cred_governance_artifact_static_lock_2026-06-01.md"
RUNTIME = ROOT / r"runtime/upbit_gate18_cred_governance_artifact_static_lock_20260601.json"
TESTFILE = ROOT / r"tests/test_upbit_gate18_cred_governance_artifact_static_lock_20260601.py"
QA = ROOT / r"reports/upbit_gate18_cred_governance_artifact_static_lock_closing_qa_2026-06-01.md"
VERDICT = ROOT / r"reports/upbit_gate18_cred_governance_artifact_static_lock_final_verdict_2026-06-01.md"
PHASE_ID = "GATE_18_CRED_GOVERNANCE_ARTIFACT_STATIC_LOCK"
VERDICT_KEY = "PASS_GATE18_CRED_GOVERNANCE_STATIC_ONLY"
class TestGATE18CRED(unittest.TestCase):
