...
class TestEndpointMatrixHardBlocksOrderCreate(unittest.TestCase):
    def test_endpoint_matrix_hard_blocks_order_create(self) -> None:
        ...
        self.assertIn("order create endpoint class", text)
