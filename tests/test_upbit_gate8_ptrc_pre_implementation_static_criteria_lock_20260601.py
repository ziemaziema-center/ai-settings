...
REPORT = ROOT / r"reports/upbit_gate8_ptrc_pre_implementation_static_criteria_lock_2026-06-01.md"
RUNTIME = ROOT / r"runtime/upbit_gate8_ptrc_pre_implementation_static_criteria_lock_20260601.json"
TESTFILE = ROOT / r"tests/test_upbit_gate8_ptrc_pre_implementation_static_criteria_lock_20260601.py"
QA = ROOT / r"reports/upbit_gate8_ptrc_pre_implementation_static_criteria_lock_closing_qa_2026-06-01.md"
VERDICT = ROOT / r"reports/upbit_gate8_ptrc_pre_implementation_static_criteria_lock_final_verdict_2026-06-01.md"
PHASE_ID = "GATE_8_PTRC_PRE_IMPLEMENTATION_STATIC_CRITERIA_LOCK"
VERDICT_KEY = "PASS_GATE8_PTRC_PRE_IMPLEMENTATION_STATIC_ONLY"
class TestGATE8PTRC(unittest.TestCase):
