...
class TestCandidateMatrixHardBlocksOrderCreate(unittest.TestCase):
    def test_candidate_matrix_hard_blocks_order_create(self) -> None:
        ...
        self.assertIn("order create endpoint", text)
