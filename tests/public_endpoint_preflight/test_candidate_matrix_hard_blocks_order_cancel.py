...
class TestCandidateMatrixHardBlocksOrderCancel(unittest.TestCase):
    def test_candidate_matrix_hard_blocks_order_cancel(self) -> None:
        ...
        self.assertIn("order cancel endpoint", text)
