...
DIGEST_DIR = OUTPUT_DIR / "long_observation_digests"
RESULT_JSON = OUTPUT_DIR / "public_data_long_observation_result_v1.json"
RESULT_MD = OUTPUT_DIR / "public_data_long_observation_result_v1.md"
...
def write_digest(cycle: int, statuses: list, endpoints: list) -> None:
    ...
    lines = [
        f"# LONG PUBLIC DATA OBSERVATION DIGEST CYCLE {cycle:03d}",
        "",
        f"- cycle: {cycle}",
...
def write_results(result: dict) -> None:
    ...
    lines = [
        "# PUBLIC DATA LONG OBSERVATION RESULT V1",
        "",
